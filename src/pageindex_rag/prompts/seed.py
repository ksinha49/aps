...
Usage::
    ...
    python -m pageindex_rag.prompts.seed --table-name pageindex-prompts --region us-east-1
"""
...
_TEMPLATE_MODULES: dict[tuple[str, str], str] = {
    ("aps", "indexing"): "pageindex_rag.prompts.templates.aps.indexing",
    ("aps", "retrieval"): "pageindex_rag.prompts.templates.aps.retrieval",
    ("aps", "extraction"): "pageindex_rag.prompts.templates.aps.extraction",
    ("aps", "classification"): "pageindex_rag.prompts.templates.aps.classification",
    ("base", "indexing_agent"): "pageindex_rag.prompts.templates.base.indexing_agent",
    ("base", "retrieval_agent"): "pageindex_rag.prompts.templates.base.retrieval_agent",
    ("base", "extraction_agent"): "pageindex_rag.prompts.templates.base.extraction_agent",
}
...
def main(argv: list[str] | None = None) -> None:
    """Entry point for ``python -m pageindex_rag.prompts.seed``."""
    parser = argparse.ArgumentParser(
        description="Seed DynamoDB prompt table from file-based templates.",
    )
    parser.add_argument(
        "--table-name",
        default="pageindex-prompts",
        help="DynamoDB table name (default: pageindex-prompts)",
    )
    parser.add_argument(
        "--region",
        default="us-east-1",
