...
Usage::
    ...
    from pageindex_rag.prompts import configure, PromptContext
    ...
    from pageindex_rag.prompts import set_active_context
...
from pageindex_rag.prompts.backends.protocol import IPromptBackend
