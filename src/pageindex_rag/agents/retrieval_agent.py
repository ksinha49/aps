...
from pageindex_rag.prompts.templates.base.retrieval_agent import RETRIEVAL_SYSTEM_PROMPT
from pageindex_rag.skills.retrieval import batch_retrieve, tree_search
...
def create_retrieval_agent(settings: AppSettings, **kwargs: Any) -> Agent:
    ...
    return Agent(
        ...
        name="PageIndex Retrieval Agent",
