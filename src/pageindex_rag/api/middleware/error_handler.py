...
def register_error_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(PageIndexError)
    async def handle_generic_error(request: Request, exc: PageIndexError) -> JSONResponse:
        return JSONResponse(status_code=500, content={"error": str(exc), "type": "pageindex_error"})
